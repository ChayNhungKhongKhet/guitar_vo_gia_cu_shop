                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-12">
                            <div class="pe_top_right_section">
                                <div class="pe_top_search">
                                    ...
                                    <a href="javascript:void(0);"><img src="/images/header_search.svg" alt="images"></a>
                                </div>
                                </div>
                            </div>
                        </div>
            ...
            <header class="pe_header_wrapper fixed_header">
                <div class="container">
                    <div class="pe_main_header_row">
                            <div class="pe_logo">
                                <a href="javascript:void(0);"> <img src="/images/header_category.png" alt="logo"> <span>Categories</span> </a>
                                        ...
                                        <ul class="display_flex">
                                            ...
                                            <li class="pe_user_form_wrapper">
                                                <a id="show" href="javascript:void(0);">
                                                    <svg style="fill: #fff;" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15">
                                                        <path d="M14.253,14.581A7.1,7.1,0,0,0,10.2,9.389a4.735,4.735,0,1,0-5.81.007A7.26,7.26,0,0,0,.323,14.58l-0.06.318H1.915l0.045-.212A5.407,5.407,0,0,1,7.288,10.4a5.407,5.407,0,0,1,5.327,4.29L12.66,14.9h1.651ZM7.288,2.517A3.109,3.109,0,1,1,4.2,5.627,3.1,3.1,0,0,1,7.288,2.517Z"></path>
                                                    </svg>
                                                </a>
                                                <div class="pe_user_form" style="display: none;">
                                                    <div class="form-wrap">
                                                        ...
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            ...
                                                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">Login</a></li>
                                                        </ul>
                                                        <!-- Tab panes -->
                                                            ...
                                                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                                                <div id="signup-tab-content" class="active">
                                                                    <form class="signup-form" method="post">
                                                                        ...
                                                                        <input type="password" class="input" autocomplete="off" placeholder="Password">
