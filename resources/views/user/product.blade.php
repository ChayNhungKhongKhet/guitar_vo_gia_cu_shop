...
<section>
    <div class="pe_in_banner_wrapper">
        ...
        <div class="d-flex justify-content-end"> <!-- Thêm class d-flex justify-content-end vào đây -->
            <form action="{{ url('/product-show') }}" method="GET" class="row g-3 align-items-center">
                <div class="col-auto">
...
{{-- <section>
        <div class="pe_in_banner_wrapper">
            ...
            <div>
                <form action="{{ url('/product-show') }}" method="GET" class="row g-3 align-items-center justify-content-start">
<div class="col-auto">
    <label for="searchTerm" class="visually-hidden">Search</label>
    <input type="text" class="form-control" id="searchTerm" placeholder="Search" name="searchTerm" value="{{ $searchTerm ?? '' }}">
</div>
                ...
                <div class="col-lg-9 col-md-12 col-sm-12 order-lg-2 order-md-1 order-sm-1 order-1">
                    <div class="collection_main_wrapper">
                        <div class="wrapper">
                            ...
                            @livewire('products-table', ['products' => $products])
                        </div>
                        <!-- /wrapper -->
                    </div>
                </div>
