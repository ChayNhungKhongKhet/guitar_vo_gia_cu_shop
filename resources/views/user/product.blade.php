...
@section('content')
                ...
                <div class="pe_in_banner_section">
                    ...
                    <div class="pe_in_banner_subheading">
                        <ul>
                            ...
                            <li><p class="pe_in_banner_text2" style="color: #909090"><i class="fa fa-caret-right"></i></p></li>
                            <li><a class="pe_in_banner_text3" style="color: #191919" href="javascript:void(0);">Product</a></li>
                        </ul>
                    </div>          
                </div>   
            </div>
            <div class="d-flex justify-content-end"> <!-- Thêm class d-flex justify-content-end vào đây -->
                <form action="{{ route('product.show') }}" method="GET" class="row g-3 align-items-center">
                    <div class="col-auto">
    ...
    {{-- <section>
        <div class="pe_in_banner_wrapper">
                ...
                <div class="pe_in_banner_section">
                    ...
                    <div class="pe_in_banner_subheading">
                        <ul>
                            ...
                            <li><a class="pe_in_banner_text3" style="color: #191919"
            ...
            <div>
                <form action="{{ route('product.show') }}" method="GET" class="row g-3 align-items-center justify-content-start">
                    <div class="col-auto">
                        <label for="searchTerm" class="visually-hidden">Search</label>
                        <input type="text" class="form-control" id="searchTerm" placeholder="Search" name="searchTerm" value="{{ $searchTerm ?? '' }}">
                    </div>
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="pe_fashion_img_section">
                                 <div class="pe_fashion_img">
                                    <img src="http://placehold.it/255x255" alt="images">
                                </div>
